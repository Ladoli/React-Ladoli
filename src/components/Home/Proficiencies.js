...
const skillCards = {maxWidth: "150px"};
...
class Proficiencies extends Component {
  ...
  render() {
    ...
    const specialty = this.props.type === 'speciality';
    ...
    return (
      <div style={{ display: "block", height: "100%"}}>
        <div className="proficiencyBlock flexCenterAll" style={{clear:"both",
                      width: "100%",
                      minHeight: "100vh",
                      backgroundColor: specialty ? "" : "transparent",
                      backgroundImage: specialty ? "" : "none"
                  }}>
          <div style={{paddingBottom:"30px"}}>
            <Header as="h3" style={{...{fontSize: "4vh", marginBottom: "3vh"},...homeHeader}}>{specialty ? "My main skills are" : "I also have experience with:"} </Header>
            <Card.Group className="cardsVi">
                {
                  specialty ? this.renderSpecialties() : this.renderExperienced()
                }
